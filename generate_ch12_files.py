...
# 基本路徑
BASE_PATH = r"D:\python_workspace\github\iSpan_python-basic-cookbooks\fundamentals\ch12-functions"
...
# 寫入檔案
with open(os.path.join(BASE_PATH, "02-worked-examples.ipynb"), 'w', encoding='utf-8') as f:
    json.dump(worked_examples, f, ensure_ascii=False, indent=1)

print("✅ 02-worked-examples.ipynb 已生成")
