...
- [x] **1.2.4.1.2** 01-lecture.ipynb（完整講義，26K）
...
- [x] **1.2.4.1.6** 05-solutions.ipynb（30題完整解答，37K）
- [x] **1.2.4.1.7** quiz.ipynb（25題自我測驗，28K）
