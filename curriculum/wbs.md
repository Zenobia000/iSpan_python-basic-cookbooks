...
- [ ] **1.2.1.3.3** 02-worked-examples.ipynb（詳解範例）
- [ ] **1.2.1.3.4** 03-practice.ipynb（課堂練習）
- [ ] **1.2.1.3.5** 04-exercises.ipynb（課後習題）
- [ ] **1.2.1.3.6** 05-solutions.ipynb（習題解答）
- [ ] **1.2.1.3.7** quiz.ipynb（自我測驗）

**完成度**：30%（核心檔案已建立）
**預估時數**：25 小時（剩餘 17.5 小時）
**預計完成**：Week 1
**GitHub**: 🔄 核心檔案已上傳
...
##### 1.2.5.3 Ch18: 繼承與多型 🔄
- [x] **1.2.5.3.1** README.md（基礎框架）
- [x] **1.2.5.3.2** 01-lecture.ipynb（框架）
- [x] **1.2.5.3.3** 02-worked-examples.ipynb（框架）
- [x] **1.2.5.3.4** 03-practice.ipynb（框架）
- [x] **1.2.5.3.5** 04-exercises.ipynb（框架）
- [x] **1.2.5.3.6** 05-solutions.ipynb（框架）
- [x] **1.2.5.3.7** quiz.ipynb（框架）
