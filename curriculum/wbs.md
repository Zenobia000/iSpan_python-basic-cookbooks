...
- [x] **1.2.4.1.2** 01-lecture.ipynb（講義框架，26.5K）
- [ ] **1.2.4.1.3** 02-worked-examples.ipynb（詳解範例待補充）
- [ ] **1.2.4.1.4** 03-practice.ipynb（課堂練習待補充）
- [ ] **1.2.4.1.5** 04-exercises.ipynb（課後習題待補充）
- [ ] **1.2.4.1.6** 05-solutions.ipynb（解答待補充）
- [ ] **1.2.4.1.7** quiz.ipynb（測驗待補充）

**完成度**：30%（README + Lecture 框架完成）
**預估時數**：35 小時（剩餘 25 小時）
**預計完成**：Week 7
**GitHub**: 🔄 框架已上傳
...
- [x] **1.2.6.3.2** 01-lecture.ipynb（6 個完整範例，35.4K）
- [x] **1.2.6.3.3** 02-worked-examples.ipynb（4 個除錯案例，31.3K）
- [x] **1.2.6.3.4** 03-practice.ipynb（8 題練習，17.6K）
- [x] **1.2.6.3.5** 04-exercises.ipynb（12 題習題，23.3K）
- [ ] **1.2.6.3.6** 05-solutions.ipynb（解答待補充，僅 399B 框架）
- [ ] **1.2.6.3.7** quiz.ipynb（測驗待補充，僅 399B 框架）

**完成度**：71%（核心教學內容+練習習題完成，解答測驗待補充）
**預估時數**：30 小時（剩餘 9 小時）
**預計完成**：Week 11
**GitHub**: 🔄 核心已上傳
